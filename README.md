...
```
### Test: 
Download the testing data at [DarkFace](https://flyywh.github.io/CVPRW2019LowLight/), [ExDark](https://github.com/cs-chan/Exclusively-Dark-Image-Dataset), [LOL](https://daooshee.github.io/BMVC2018website/), [SICE](https://github.com/csjcai/SICE#learning-a-deep-single-image-contrast-enhancer-from-multi-exposure-images), [VV](https://sites.google.com/site/vonikakis/datasets), [DICM](http://mcl.korea.ac.kr/projects/LDR/) and [NPE](https://blog.sina.com.cn/u/2694868761).
